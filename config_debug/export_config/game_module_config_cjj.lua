return {
	config=
	{
		...
		{
			id = 312,
			key = "act_ty_by_drop_style/act_031_denglong",
			desc = "欢乐券掉落",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 313,
			key = "act_ty_by_hhl_style/act_021_hhl",
			desc = "换好礼皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 315,
			key = "sys_act_base_style/sys_act_base_weekly_046",
			desc = "扩展活动皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 329,
			key = "act_ty_gifts_style/act_015_jclb",
			desc = "消暑礼包",
			is_on_off = 1,
			enable = 1,
			state = 1,
