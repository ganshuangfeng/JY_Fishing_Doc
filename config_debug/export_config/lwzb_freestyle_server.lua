return {
	...
	bet_limit=
	{
		...
		[15]=
		{
			id = 15,
			bet_id = 2,
			base_limit = {40000000,40000000,40000000,40000000},
			my_total_bet_limit = 30,
			total_bet_limit = 40000000,
			permission_key = "lwzb_bet_limit_6",
		},
		[16]=
		{
			id = 16,
			bet_id = 2,
			base_limit = {50000000,50000000,50000000,50000000},
			my_total_bet_limit = 30,
			total_bet_limit = 50000000,
			permission_key = "lwzb_bet_limit_7",
		},
		[17]=
		{
			id = 17,
			bet_id = 2,
			base_limit = {80000000,80000000,80000000,80000000},
			my_total_bet_limit = 30,
			total_bet_limit = 80000000,
			permission_key = "lwzb_bet_limit_8",
		},
		[18]=
		{
			id = 18,
			bet_id = 2,
			base_limit = {100000000,100000000,100000000,100000000},
			my_total_bet_limit = 30,
			total_bet_limit = 100000000,
			permission_key = "lwzb_bet_limit_9",
		},
	},
	enter_cfg=
