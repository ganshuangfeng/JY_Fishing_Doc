return {
	task=
	{
		...
		[2]=
		{
			...
			name = "中级场对局红包",
			own_type = "normal",
			task_enum = "zhongji_duiju_hongbao",
			process_id = 2,
			is_reset = 1,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[47]=
		{
			id = 47,
			enable = -1,
			name = "bbsc_new_6-2邀请一位好友完成新人红包第一天",
			own_type = "step_task",
			task_enum = "common",
			process_id = 47,
			is_reset = 0,
		...
		[48]=
		{
			id = 48,
			enable = -1,
			name = "bbsc_new_7-1邀请一位好友完成新人红包第二天",
			own_type = "step_task",
			task_enum = "common",
			process_id = 48,
			is_reset = 0,
		...
		[70]=
		{
			...
			name = "子任务-邀请信",
			own_type = "normal",
			task_enum = "sczd_achievement_children_task",
			process_id = 70,
			is_reset = 0,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[74]=
		{
			...
			enable = 1,
			name = "消消乐-每日任务",
			own_type = "xiaoxiaole_daily_task",
			task_enum = "xiaoxiaole_daily_task",
			process_id = 74,
			is_reset = 1,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[75]=
		{
			...
			enable = 1,
			name = "水浒消消乐-每日任务",
			own_type = "shuihu_xiaoxiaole_daily_task",
			task_enum = "xiaoxiaole_daily_task",
			process_id = 75,
			is_reset = 1,
			reset_delay = 1,
		...
		[80]=
		{
			id = 80,
			enable = 1,
			name = "全返礼包3，20次任务，小游戏累计赢金200万可领取5元激励金",
			own_type = "sczd_all_return_task3",
			task_enum = "all_return_gift_lb",
			process_id = 80,
			is_reset = 1,
			reset_delay = 1,
		...
		[81]=
		{
			...
			enable = 1,
			name = "新玩家水果消消乐红包任务",
			own_type = "new_player_xiaoxiaole_task",
			task_enum = "new_player_buyu_task",
			process_id = 81,
			is_reset = 0,
			reset_delay = 1,
		...
		[90]=
		{
			...
			enable = 1,
			name = "全返礼包1（冲金鸡）",
			own_type = "sczd_all_return_task1_cjj",
			task_enum = "all_return_gift_lb",
			process_id = 90,
			is_reset = 1,
			reset_delay = 1,
		...
		[91]=
		{
			...
			enable = 1,
			name = "全返礼包2（冲金鸡）",
			own_type = "sczd_all_return_task2_cjj",
			task_enum = "all_return_gift_lb",
			process_id = 91,
			is_reset = 1,
			reset_delay = 1,
		...
		[92]=
		{
			...
			enable = 1,
			name = "全返礼包3（冲金鸡）",
			own_type = "sczd_all_return_task3_cjj",
			task_enum = "all_return_gift_lb",
			process_id = 92,
			is_reset = 1,
			reset_delay = 1,
		...
		[97]=
		{
			...
			enable = 1,
			name = "疯狂返利（累计赢金）",
			own_type = "p_crary_rebate",
			task_enum = "common",
			process_id = 97,
			is_reset = 1,
			reset_delay = 20,
			start_valid_time = 1619452800,
			end_valid_time = 1635004799,
			time_limit = -1,
			is_send_client = 1,
		},
		[98]=
		...
		[30020]=
		{
			...
			name = "新手任务-使用1次锁定",
			own_type = "p_new_player_task",
			task_enum = "common:prev_task:30019",
			process_id = 120,
			is_reset = 0,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[30021]=
		{
			...
			enable = 1,
			name = "新手任务-累计消耗3万金币",
			own_type = "p_new_player_task_1",
			task_enum = "common:prev_task:30020",
			process_id = 121,
			is_reset = 0,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[30022]=
		{
			...
			name = "新手任务-累计消耗5万金币",
			own_type = "p_new_player_task",
			task_enum = "common:prev_task:30021",
			process_id = 122,
			is_reset = 0,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[30023]=
		{
			...
			enable = 1,
			name = "新手任务-累计开炮500发",
			own_type = "p_new_player_task_2",
			task_enum = "common:prev_task:30022",
			process_id = 123,
			is_reset = 0,
			reset_delay = 1,
			start_valid_time = 946677600,
		...
		[30036]=
		{
			...
			enable = 1,
			name = "回归签到V1-V3",
			own_type = "p_come_back_task1",
			task_enum = "common",
			process_id = 136,
			is_reset = 1,
			reset_delay = 7,
			start_valid_time = 1635206400,
			end_valid_time = 32503651200,
			time_limit = -1,
			is_send_client = 1,
		},
		...
		[30040]=
		{
			...
			name = "回归礼遇（付费）",
			own_type = "p_come_back_courtesy",
			task_enum = "hgly_buy_gift_get_award_task",
			process_id = 140,
			is_reset = 1,
			reset_delay = 7,
			start_valid_time = 1635206400,
	...
	process_data=
	{
		...
		[14]=
		{
			id = 14,
			process_id = 14,
			condition_type = "pre_progress_duiju",
			source_id = 14,
			process = 1,
			awards = 13,
			get_award_type = "nor",
		...
		[19]=
		{
			id = 19,
			process_id = 19,
			condition_type = "pre_invite_play_bbsc",
			source_id = 19,
			process = 1,
			awards = 18,
			get_award_type = "nor",
		...
		[61]=
		{
			id = 61,
			process_id = 61,
			condition_type = "bbsc_big_step_complete",
			source_id = 61,
			process = {1,2,2,2},
			awards = {66,67,68,69},
		},
		...
		[67]=
		{
			id = 67,
			process_id = 67,
			condition_type = "game_profit_for_xianwan",
			source_id = 67,
			process = 99999999999,
			get_award_type = "nor",
		},
		...
		[69]=
		{
			id = 69,
			process_id = 69,
			condition_type = "sczd_achievement_sys",
			source_id = 69,
			process = {5,30,60,85,240},
			awards = {73,74,75,76,77},
			get_award_type = "nor",
		},
		[70]=
		{
			id = 70,
			process_id = 70,
			condition_type = "read_invite_msg",
			source_id = 70,
			process = 0,
			awards = 88,
			get_award_type = "nor",
		...
		[71]=
		{
			id = 71,
			process_id = 71,
			condition_type = "open_sczd_bisai_profit_switch",
			source_id = 71,
			process = 1,
			awards = 89,
			get_award_type = "nor",
		...
		[72]=
		{
			id = 72,
			process_id = 72,
			condition_type = "open_sczd_lb_profit_switch",
			source_id = 72,
			process = 1,
			awards = 90,
			get_award_type = "nor",
		...
		[73]=
		{
			id = 73,
			process_id = 73,
			condition_type = "answer_sczd_test_paper",
			source_id = 73,
			process = 1,
			awards = 91,
			get_award_type = "nor",
		...
		[81]=
		{
			id = 81,
			process_id = 81,
			condition_type = "xiaoxiaole_spend",
			source_id = 81,
			process = 1000000000,
			pre_add_process = 500000000,
			awards = 97,
		...
		[97]=
		{
			...
			process_id = 97,
			source_id = 96,
			process = {50000,300000,350000,500000,800000,2000000,4000000,7000000,10000000,10000000,25000000,40000000,100000000,200000000,250000000,350000000,500000000,1000000000,1500000000,2500000000,2500000000,6000000000,5000000000,15000000000,15000000000,20000000000,30000000000,50000000000,50000000000,100000000000,50000000000},
			awards = {124,125,126,127,128,129,130,131,132,133,134,135,136,137,138,139,140,141,142,143,144,145,146,147,148,149,150,151,152,153,154},
			get_award_type = "nor",
		},
		[98]=
		{
		...
		[124]=
		{
			...
			process_id = 124,
			source_id = 119,
			process = {5,5,10,10,20},
			awards = {195,196,197,198,199},
			get_award_type = "nor",
		},
		[125]=
		{
		...
		[127]=
		{
			...
			process_id = 127,
			source_id = 122,
			process = {200,300,500,2000,2000},
			awards = {205,206,207,208,209},
			get_award_type = "nor",
		},
		[128]=
		{
			...
			process_id = 128,
			source_id = 119,
			process = {20,30,50,100,300},
			awards = {210,211,212,213,214},
			get_award_type = "nor",
		},
		[129]=
		{
		...
		[130]=
		{
			...
			process_id = 130,
			source_id = 101,
			process = {10000000,40000000,50000000,200000000,200000000},
			awards = {220,221,222,223,224},
			get_award_type = "nor",
		},
		[131]=
		{
			...
			process_id = 131,
			source_id = 125,
			process = {1000,9000,10000,30000,50000},
			awards = {225,226,227,228,229},
			get_award_type = "nor",
		},
		[132]=
		{
			...
			awards = {230,231,232,233,234,235},
			get_award_type = "nor",
		},
		[133]=
		{
		...
		[134]=
		{
			...
			process_id = 134,
			source_id = 96,
			process = {100000,200000,200000,300000,200000,1000000,1500000,5500000,9000000,12000000,20000000,40000000,60000000,100000000,200000000,300000000,250000000,500000000,1500000000,2000000000,5000000000,20000000000,30000000000,40000000000,50000000000,50000000000},
			awards = {236,236,237,238,239,240,241,242,243,244,245,246,247,248,249,250,251,252,253,254,255,256,257,258,259,260},
			get_award_type = "nor",
		},
		[135]=
		{
			...
			process_id = 135,
			source_id = 97,
			process = {800,3200,6000,10000,20000,50000,60000,50000,80000,120000,250000,150000,400000,400000,400000},
			awards = {261,261,262,263,264,265,266,267,268,269,270,271,272,273,274},
			get_award_type = "nor",
		},
		[136]=
		{
			...
			awards = {275,276,277,278,279,280,281},
			get_award_type = "nor",
		},
		[137]=
		{
			...
			source_id = 126,
			process = {1,1,1,1,1,1,1},
			awards = {282,283,284,285,286,287,288},
			get_award_type = "nor",
		},
		[138]=
		{
			...
			source_id = 126,
			process = {1,1,1,1,1,1,1},
			awards = {289,290,291,292,293,294,295},
			get_award_type = "nor",
		},
		[139]=
		{
			...
			process_id = 139,
			source_id = 119,
			process = {10,20,20,50,100,300,500,1000},
			awards = {296,297,298,299,300,301,302,303},
			get_award_type = "nor",
		},
		[140]=
		{
			...
			source_id = 119,
			process = {10,20,20,50,100,300,500,1000},
			awards = {304,305,306,307,307,307,307,308},
			get_award_type = "nor",
		},
		[141]=
		{
	...
	source=
	{
		...
		[14]=
		{
			id = 14,
			source_id = 14,
			source_type = "pre_progress_duiju",
			condition_id = 18,
		},
		[15]=
		{
		...
		[19]=
		{
			id = 19,
			source_id = 19,
			source_type = "pre_invite_play_bbsc",
			condition_id = 11,
		},
		[20]=
		{
		...
		[61]=
		{
			id = 61,
			source_id = 61,
			source_type = "bbsc_big_step_complete",
			condition_id = 0,
		},
		[62]=
		{
		...
		[67]=
		{
			id = 67,
			source_id = 67,
			source_type = "game_profit_for_xianwan",
			condition_id = 0,
		},
		[68]=
		{
		...
		[69]=
		{
			id = 69,
			source_id = 69,
			source_type = "sczd_achievement_sys",
			condition_id = 0,
		},
		[70]=
		{
		...
		[71]=
		{
			id = 71,
			source_id = 71,
			source_type = "open_sczd_bisai_profit_switch",
			condition_id = 0,
		},
		[72]=
		{
			id = 72,
			source_id = 72,
			source_type = "open_sczd_lb_profit_switch",
			condition_id = 0,
		},
		[73]=
		{
			id = 73,
			source_id = 73,
			source_type = "answer_sczd_test_paper",
			condition_id = 0,
		},
		[74]=
		{
	...
	condition=
	{
		...
		[67]=
		{
			...
			condition_id = 36,
			condition_name = "gift_id",
			condition_value = {10084,10,10080,10169,10190,10087,10088,10290,10291,10346,10347},
			judge_type = 5,
		},
		[68]=
		{
	...
	award_data=
	{
		...
		[54]=
		{
			id = 54,
			award_id = 63,
			asset_type = "obj_qianyuansai_ticket_604800",
			asset_count = 1,
			get_weight = 1,
		},
		[55]=
