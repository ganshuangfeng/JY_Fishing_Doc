return {
	...
	task=
	{
		...
		[21]=
		{
			...
			level = 1,
			item = {"prop_tiny_game_icon","prop_fish_drop_act_0","prop_3d_fish_lock"},
			count = {188888,50,3},
		...
		[23]=
		{
			...
			level = 1,
			item = {"prop_tiny_game_icon","prop_fish_drop_act_0","prop_3d_fish_doubled"},
			count = {588888,150,3},
			gotoUI = {"shop_bay","jing_bi",},
		},
		[24]=
		...
		[25]=
		{
			...
			level = 1,
			item = {"prop_tiny_game_icon","prop_fish_drop_act_0"},
			count = {8888888,8888},
			gotoUI = {"shop_bay","jing_bi",},
		...
		[27]=
		{
			...
			level = 1,
			item = {"prop_tiny_game_icon","prop_fish_drop_act_0","swjl_5",},
		...
		[30]=
		{
			...
			task_name = "在商城中购买3次15元",
			level = 1,
			item = {"prop_tiny_game_icon","prop_fish_drop_act_0","prop_guess_apple_bet_1"},
			count = {188888,50,1},
			gotoUI = {"shop_bay","jing_bi",},
			Tips = {"","","请在苹果大战中使用"},
		},
