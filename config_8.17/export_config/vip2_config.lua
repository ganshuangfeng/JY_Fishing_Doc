return {
	...
	vip=
	{
		[1]=
		{
			index = 1,
			vip_level = 0,
			dec_txt = {"*解锁自动开炮特权","*解锁1元支付宝奖励金","*解锁兑换商城实物商品"},
		},
		[2]=
		{
			index = 2,
			vip_level = 1,
			dec_txt = {"*解锁VIP超级转盘","*解锁3元支付宝奖励金","*解锁10元京东卡"},
		},
		[3]=
		{
			index = 3,
			vip_level = 2,
			dec_txt = {"*解锁闪耀风暴炮台","*解锁5元支付宝奖励金","*解锁20元京东卡，50元话费"},
		},
		[4]=
		{
			index = 4,
			vip_level = 3,
			dec_txt = {"*解锁10元支付宝奖励金","*解锁100元京东卡，100元话费","*福利券容量提升到15万"},
		},
		[5]=
		{
			index = 5,
			vip_level = 4,
			dec_txt = {"*解锁金币使者炮台","*解锁200元、300元京东卡","*福利券容量提升到30万"},
		},
		[6]=
		{
			index = 6,
		...
		[7]=
		{
			index = 7,
			vip_level = 6,
			dec_txt = ""*福利券容量提升到100万"",
		},
		[8]=
		{
			index = 8,
			vip_level = 7,
			dec_txt = ""*福利券容量提升到200万"",
		},
		[9]=
		{
			index = 9,
			vip_level = 8,
			dec_txt = ""*福利券容量提升到300万"",
		},
		[10]=
		{
			index = 10,
			vip_level = 9,
			dec_txt = ""*福利券容量提升到500万"",
		},
		[11]=
		{
			index = 11,
			vip_level = 10,
			dec_txt = {"*每日免费领取至尊礼包","*领30次礼包额外奖励1000万鱼币","*福利券容量提升到800万"},
		},
		[12]=
		{
			index = 12,
			vip_level = 11,
			dec_txt = {"*每日免费领取至尊礼包","*领30次礼包额外奖励200元话费","*福利券容量提升到1200万"},
		},
	},
	vip_up=
	{
		[1]=
		{
			index = 1,
			vip_level = 1,
			desc = {"抽奖券","炮台基座","自动开炮","1元支付宝红包","存钱罐","福利券容量提升"},
			name_txt = {"抽奖券","绿芒","自动开炮","兑换特权","存钱罐","容量提升"},
		},
		[2]=
		{
			index = 2,
