return {
	config=
	{
		[1]=
		{
			...
			show_hb = 3,
			hb_show = "0.01;0.03;0.05#0.05;0.1;0.15#0.4;0.5;0.6",
			key = "actp_own_task_p_ljyjcfk_hlw",
			asset_value = {0.01,0.03,0.05,0.05,0.1,0.15,0.4,0.5,0.6},
		...
		[2]=
		{
			...
			show_hb = 6,
			hb_show = "0.1;0.3;0.5#0.5;1;1.5#4;5;6",
			key = "actp_own_task_p_ljyjcfk_hlw",
			asset_value = {0.1,0.3,0.5,0.5,1,1.5,4,5,6},
			asset_type = {"shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum","shop_gold_sum"},
		},
	},
	jjconfig=
