return {
	...
	config_normal=
	{
		[1]=
		{
			...
			title = "5020万金币",
			jg = "498元",
			tips = {"双倍奖励卡，请在3D捕鱼中使用","活动期间可开启，最高可得2000福利券！"},
		...
		[3]=
		{
			...
			title = "996万金币",
			jg = "98元",
			tips = {"双倍奖励卡，请在3D捕鱼中使用","活动期间可开启，最高可得1000福利券！"},
		...
		[4]=
		{
			...
			title = "488万金币",
			jg = "48元",
			tips = {"双倍奖励卡，请在3D捕鱼中使用","活动期间可开启，最高可得500福利券！"},
	...
	config_cjj=
	{
		[1]=
		{
			...
			title = "5000万金币",
			jg = "498元",
			tips = {"请在苹果大战中使用","活动期间可开启，最高可得2000福利券！"},
			bx_img = "ty_lb1_btn_bx3",
			shop_id = 10486,
		...
		[3]=
		{
			...
			title = "996万金币",
			jg = "98元",
			tips = {"请在苹果大战中使用","活动期间可开启，最高可得1000福利券！"},
			bx_img = "ty_lb1_btn_bx2",
			shop_id = 10488,
		...
		[4]=
		{
			...
			title = "488万金币",
			jg = "48元",
			tips = {"请在苹果大战中使用","活动期间可开启，最高可得500福利券！"},
			bx_img = "ty_lb1_btn_bx1",
			shop_id = 10489,
