return {
	config=
	{
		...
		{
			id = 316,
			key = "act_ty_sjb_style/act_024_dlphb",
			desc = "掉落排行榜皮肤（消耗）",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 317,
			key = "act_ty_by_drop_style/act_022_fengye",
			desc = "枫叶掉落",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 318,
			key = "act_ty_by_hhl_style/act_014_hhl",
			desc = "换好礼皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 320,
			key = "sys_act_base_style/sys_act_base_weekly_026",
			desc = "扩展活动皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
