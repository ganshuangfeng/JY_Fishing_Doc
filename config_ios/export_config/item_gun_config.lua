return {
	config=
	{
		...
		[3]=
		{
			...
			buy_anniu_hint = "获取",
			gift_id = 10345,
			attribute = {"<color=#fffd33>激光炮：直线方向释放激光，有几率捕获激光所发射范围内的任意鱼类</color>",},
		...
		[4]=
		{
			...
			buy_anniu_hint = "获取",
			gift_id = 10344,
			attribute = {"<color=#fffd33>穿透弹：发射一发穿透弹，可捕获同移动线上的任意鱼类</color>",},
		...
		[5]=
		{
			...
			buy_anniu_hint = "获取",
			gift_id = 10343,
			attribute = {"<color=#fffd33>核能炮：在屏幕中间释放一颗小型原子弹，随机捕获炸弹范围内的任意鱼类</color>",},
		...
		[6]=
		{
			...
			buy_anniu_hint = "获取",
			gift_id = 10342,
			attribute = {"<color=#fffd33>死亡之灵：攻击指定点，捕获周围鱼类</color>","<color=#ffffff>被动效果：提高捕获奖金鱼后获得高倍的几率</color>"},
		...
		[7]=
		{
			...
			buy_anniu_hint = "获取",
			gift_id = 10341,
			attribute = {"<color=#fffd33>神龙杀：瞬间提高子弹250%的杀伤力</color>","<color=#ffffff>被动效果：提高击杀龙王的概率</color>"},
