return {
	...
	help_info=
	{
		...
		{
			id = 1,
			text = "1.畅享卡购买后立得500万金币，剩余20天每日登陆可领40万金币。",
		},
		[2]=
		{
			id = 2,
			text = "2.每日完成2个任务共领500福利券，每个任务每日限领1次，共领20次。",
		},
		[3]=
		{
			id = 3,
			text = "3.任务刷新首次免费，之后每次需30000金币，次数不限。",
		},
		[4]=
		{
			id = 4,
			text = "4.当日未完成的任务次日清零，刷新重置。",
		},
		[5]=
		{
			id = 5,
			text = "5.任务需在购买内30日内完成，时间截止后任务失效。",
		},
		[6]=
		{
			id = 6,
			text = "6.6.街机捕鱼累计赢金按50%计算。",
		},
	},
	help_info_cjj=
	{
