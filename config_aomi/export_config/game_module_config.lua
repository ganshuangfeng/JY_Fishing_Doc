return {
	config=
	{
		...
		{
			id = 316,
			key = "act_ty_sjb_style/act_025_dlphb",
			desc = "掉落排行榜皮肤（消耗）",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 317,
			key = "act_ty_by_drop_style/act_023_aixin",
			desc = "爱心掉落",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 318,
			key = "act_ty_by_hhl_style/act_015_hhl",
			desc = "换好礼皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 320,
			key = "sys_act_base_style/sys_act_base_weekly_028",
			desc = "扩展活动皮肤",
			is_on_off = 1,
			enable = 1,
			state = 1,
		...
		{
			id = 334,
			key = "act_ty_gifts_style/act_006_axlb",
			desc = "爱心礼包",
			is_on_off = 1,
			enable = 1,
			state = 1,
